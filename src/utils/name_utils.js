/**
 * name_utils.js — 翻译键格式名称解析工具
 *
 * 处理三类翻译键形式的名称：
 *   完整键:  "subsystem.machine_max.engine"
 *   短名:    "engine"
 *   显示:    "[子系统]engine"
 *
 * 所有键使用点分隔格式（{type}.{ns}.{name}），与零件定义 JSON 中的 map key 一致。
 */
